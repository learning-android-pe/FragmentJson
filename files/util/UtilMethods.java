...
import com.orimex.orimex.LandingActivity;
...
import static com.orimex.orimex.util.Constants.JF_CONTACT_NUMBER;
...
/**
 * Created by Mi sesión on 12/11/2016.
 */
...
public class UtilMethods {
    ...
    public static boolean isUserSignedIn(Context context) {
        if (!TextUtils.isEmpty(getPreferenceString(context, JF_CONTACT_NUMBER))) {
            return true;
        } else {
            return false;
        }
