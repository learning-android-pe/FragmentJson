...
import com.orimex.orimex.adapter.ResultListAdapter;
import com.orimex.orimex.model.Item;
import com.orimex.orimex.util.LocationChangeListener;
...
import static com.orimex.orimex.util.Constants.ITEM_TYPE_COMPANY;
import static com.orimex.orimex.util.Constants.JF_AREA;
import static com.orimex.orimex.util.Constants.JF_CATEGORY;
import static com.orimex.orimex.util.Constants.JF_CATEGORY_ID;
import static com.orimex.orimex.util.Constants.JF_COMPANY_LIST;
import static com.orimex.orimex.util.Constants.JF_CONTACT_PHONE;
import static com.orimex.orimex.util.Constants.JF_DATA;
import static com.orimex.orimex.util.Constants.JF_DESCRIPTION;
import static com.orimex.orimex.util.Constants.JF_DISTRICT_ID;
import static com.orimex.orimex.util.Constants.JF_DISTRICT_INFO;
import static com.orimex.orimex.util.Constants.JF_DISTRICT_TITLE;
import static com.orimex.orimex.util.Constants.JF_EMAIL;
import static com.orimex.orimex.util.Constants.JF_ENTRY;
import static com.orimex.orimex.util.Constants.JF_ENTRY_TO_CATEGORY;
import static com.orimex.orimex.util.Constants.JF_FACEBOOK;
import static com.orimex.orimex.util.Constants.JF_GPLUS;
import static com.orimex.orimex.util.Constants.JF_HOLDING_NO;
import static com.orimex.orimex.util.Constants.JF_HOT_LINE;
import static com.orimex.orimex.util.Constants.JF_ID;
import static com.orimex.orimex.util.Constants.JF_IMAGES;
import static com.orimex.orimex.util.Constants.JF_ITEM_TYPE;
import static com.orimex.orimex.util.Constants.JF_LARGE_IMAGE_PATH;
import static com.orimex.orimex.util.Constants.JF_LATITUDE;
import static com.orimex.orimex.util.Constants.JF_LINKED_IN;
import static com.orimex.orimex.util.Constants.JF_LONGITUDE;
import static com.orimex.orimex.util.Constants.JF_MOBILE;
import static com.orimex.orimex.util.Constants.JF_RATING;
import static com.orimex.orimex.util.Constants.JF_RATING_COUNT;
import static com.orimex.orimex.util.Constants.JF_ROAD_VILLAGE;
import static com.orimex.orimex.util.Constants.JF_TAG_LINE;
import static com.orimex.orimex.util.Constants.JF_TELEPHONE;
import static com.orimex.orimex.util.Constants.JF_THANA;
import static com.orimex.orimex.util.Constants.JF_THUMB_IMAGE_PATH;
import static com.orimex.orimex.util.Constants.JF_TITLE;
import static com.orimex.orimex.util.Constants.JF_TWITTER;
import static com.orimex.orimex.util.Constants.JF_VERIFICATION;
import static com.orimex.orimex.util.Constants.JF_WEB;
    ...
    private void parseJson(String jsonString) {
        ...
        try {
            ...
            for (int i = 0; i < resultArray.length(); i++) {
                Item item = new Item();
                if (resultArray.getJSONObject(i).getString(JF_ITEM_TYPE).equals("")) {
                    ...
                    item.setVerification(itemObject.optString(JF_VERIFICATION, NO_DATA_FOUND).equals("") ? false : true);
